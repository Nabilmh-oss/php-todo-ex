...
// Base URL of the app (no trailing spaces)
define('BASE_URL', getenv('TODOLIST_BASE_URL') ?: '/');

// Database connection parameters from environment (12-Factor style)
define('DB_USER', getenv('TODOLIST_DB_USER') ?: 'todolist');
define('DB_PASS', getenv('TODOLIST_DB_PASS')); // no default for secrets
